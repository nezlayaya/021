...
class ControllerExtensionModuleTGKSProMegamenu extends Controller {
	...
	public function index() {  
		...
		$this->language->load('extension/module/tg_kspro_megamenu');
		...
		if(isset($_GET['delete'])) {
			...
			$this->response->redirect($this->url->link('extension/module/tg_kspro_megamenu', 'token=' . $this->session->data['token'], true));
		}
		...
		$data['action'] = $this->url->link('extension/module/tg_kspro_megamenu', 'token=' . $this->session->data['token'], true);
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/tg_kspro_megamenu', 'token=' . $this->session->data['token'], true)
		);
		...
		$this->response->setOutput($this->load->view('extension/module/tg_kspro_megamenu', $data));
	
	}
	
	private function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/tg_kspro_megamenu')) {
