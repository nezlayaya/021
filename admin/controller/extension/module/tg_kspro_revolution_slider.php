...
class ControllerExtensionModuleTGKSProRevolutionSlider extends Controller {
	private $error = array(); 
	
	public function slider() {
		$this->language->load('extension/module/tg_kspro_revolution_slider');
		...
		if(isset($_GET['slider_id'])) {
			...
			if($data == false) { 
				$this->response->redirect($this->url->link('extension/module/tg_kspro_revolution_slider/sliders', 'token=' . $this->session->data['token'], true));
			}
		...
		$data['action'] = $this->url->link('extension/module/tg_kspro_revolution_slider/slider', 'token=' . $this->session->data['token'], true);
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/tg_kspro_revolution_slider', 'token=' . $this->session->data['token'], true)
		);
		...
		$this->response->setOutput($this->load->view('extension/module/tg_kspro_revolution_slider/slider', $data));
	}
	...
	public function sliders() {
		...
		$data['action'] = $this->url->link('extension/module/tg_kspro_revolution_slider/sliders', 'token=' . $this->session->data['token'], true);
		$data['placement'] = $this->url->link('extension/module/tg_kspro_revolution_slider', 'token=' . $this->session->data['token'], true);		
		$data['existing'] = $this->url->link('extension/module/tg_kspro_revolution_slider/sliders', 'token=' . $this->session->data['token'], true);	
		$data['link_slider'] = $this->url->link('extension/module/tg_kspro_revolution_slider/slider', 'token=' . $this->session->data['token'], true);	
		$data['token'] = $this->session->data['token'];
		...
		$this->response->setOutput($this->load->view('extension/module/tg_kspro_revolution_slider/sliders', $data));
	}
	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/module/tg_kspro_revolution_slider', 'token=' . $this->session->data['token'], true));
		}
		...
		$data['action'] = $this->url->link('extension/module/tg_kspro_revolution_slider', 'token=' . $this->session->data['token'], true);
		$data['placement'] = $this->url->link('extension/module/tg_kspro_revolution_slider', 'token=' . $this->session->data['token'], true);		
		$data['existing'] = $this->url->link('extension/module/tg_kspro_revolution_slider/sliders', 'token=' . $this->session->data['token'], true);		
		$data['token'] = $this->session->data['token'];
		...
		$this->response->setOutput($this->load->view('extension/module/tg_kspro_revolution_slider/placement', $data));
	}
	
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/tg_kspro_revolution_slider')) {
