...
class ControllerExtensionModuleTgKSproSettings extends Controller {
	...
	public function index() {   
		...
		$this->language->load('extension/module/tg_kspro_settings');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			if(isset($_POST['button-active'])){
	            ...
	            $this->response->redirect($this->url->link('extension/module/tg_kspro_settings&submit=true', 'token=' . $this->session->data['token'], true));
            }
		}
			...
			if(isset($_POST['button-save'])){
				if(is_writable(DIR_CATALOG . 'view/theme/kingstorepro/skins') && is_writable(DIR_CATALOG . 'view/theme/kingstorepro/skins/store_'.$data['edit_skin_store']) && is_writable(DIR_CATALOG . 'view/theme/kingstorepro/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'])) {
					...
					if(file_exists(DIR_CATALOG . 'view/theme/kingstorepro/skins/store_'.$data['edit_skin_store'].'/') && filetype(DIR_CATALOG . 'view/theme/kingstorepro/skins/store_'.$data['edit_skin_store'].'/') == 'dir' && file_exists(DIR_CATALOG . 'view/theme/kingstorepro/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'].'')) {
						...
						$this->session->data['success'] = $this->language->get('text_success');
						$this->response->redirect($this->url->link('extension/module/tg_kspro_settings&submit=true&skin_edit=' . $data['active_skin_edit'] . '', 'token=' . $this->session->data['token'], true));
					}
				}
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {	
			...
			if(isset($_POST['install_tg_kspro_all_module'])){
				...
				$this->session->data['success'] = $this->language->get('text_success');
				$this->response->redirect($this->url->link('extension/module/tg_kspro_settings', 'token=' . $this->session->data['token'], true));
		...
		$data['action'] = $this->url->link('extension/module/tg_kspro_settings', 'token=' . $this->session->data['token'], true);
		...
		//Send the output.
		$this->response->setOutput($this->load->view('extension/module/tg_kspro_settings', $data));
	}

	private function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/tg_kspro_settings')) {
...
$this->model_setting_setting->editSettingValue('theme_default', 'theme_default_image_thumb_width', 400);	
		...
		$this->model_user_user_group->addPermission(1,'modify','extension/module/tg_kspro_revolution_slider');	
		$this->model_user_user_group->addPermission(1,'access','extension/module/tg_kspro_revolution_slider');
		
		$this->model_user_user_group->addPermission(1,'modify','extension/module/tg_kspro_megamenu');	
		$this->model_user_user_group->addPermission(1,'access','extension/module/tg_kspro_megamenu');
		
		$this->model_user_user_group->addPermission(1,'modify','extension/module/tg_kspro_megamenu_vertical');	
		$this->model_user_user_group->addPermission(1,'access','extension/module/tg_kspro_megamenu_vertical');
		
		$this->model_user_user_group->addPermission(1,'modify','extension/module/tg_kspro_filter_product');	
		$this->model_user_user_group->addPermission(1,'access','extension/module/tg_kspro_filter_product');
		...
		$this->model_user_user_group->addPermission(1,'modify','extension/module/newsletter');	
		$this->model_user_user_group->addPermission(1,'access','extension/module/newsletter');
		
		$this->model_user_user_group->addPermission(1,'modify','extension/catalog/nauthor');	
		$this->model_user_user_group->addPermission(1,'access','extension/catalog/nauthor');
		
		$this->model_user_user_group->addPermission(1,'modify','extension/catalog/ncategory');	
		$this->model_user_user_group->addPermission(1,'access','extension/catalog/ncategory');
		
		$this->model_user_user_group->addPermission(1,'modify','extension/catalog/ncomments');	
		$this->model_user_user_group->addPermission(1,'access','extension/catalog/ncomments');
		
		$this->model_user_user_group->addPermission(1,'modify','extension/catalog/news');	
		$this->model_user_user_group->addPermission(1,'access','extension/catalog/news');
		
		$this->model_user_user_group->addPermission(1,'modify','extension/common/newspanel');	
		$this->model_user_user_group->addPermission(1,'access','extension/common/newspanel');
		
		$this->model_user_user_group->addPermission(1,'modify','extension/extension/newsletter');	
		$this->model_user_user_group->addPermission(1,'access','extension/extension/newsletter');
