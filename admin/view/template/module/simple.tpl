...
<div ng-app="Simple" id="ng-app" ng-controller="simpleMainController">
    ...
    <div class="box">
      ...
      <div class="buttons">
        ...
        <?php } ?>
        <a ng-click="save()" class="button btn btn-primary"><?php echo $l->get('button_save'); ?></a><a onclick="location = '<?php echo str_replace("'", "\\'", $action_cancel); ?>';" class="button btn btn-primary"><?php echo $l->get('button_cancel'); ?></a></div>
      </div>
    </div>
    <div class="content">
