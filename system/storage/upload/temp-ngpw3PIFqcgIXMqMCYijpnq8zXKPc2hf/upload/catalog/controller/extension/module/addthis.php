<?php 
class ControllerExtensionModuleAddthis extends Controller  {
	private $moduleName = 'AddThis';
	private $moduleNameSmall = 'addthis';
	private $moduleData_module = 'addthis_module';
	private $moduleModel = 'model_extension_module_addthis';
    ...
    public function index() {
		...
		if(isset($data['product_id'])) {
				...
				if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/extension/module/'.$this->moduleNameSmall.'.tpl')) {
					
					return $this->load->view($this->config->get('config_template') . '/template/extension/module/'.$this->moduleNameSmall.'.tpl', $data);
				 } else {
					 
					 return $this->load->view('extension/module/'.$this->moduleNameSmall.'.tpl', $data);
				 }
